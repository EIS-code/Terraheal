//
//  JDSegmentControl.swift
//  Terra Heal
//
//  Created by Jaydeep on 17/06/20.
...
@IBDesignable
open class HomeSegmentedControl: UIView {

    //Version: 0.4.10
    //Configure the options to for a custom design
    
    @IBInspectable open var defaultTextFont: UIFont = FontHelper.font(name: FontName.SemiBold, size:  JDDeviceHelper.fontCalculator(size: FontSize.button_14))
    @IBInspectable open var selectedTextFont: UIFont = FontHelper.font(name: FontName.SemiBold, size:  JDDeviceHelper.fontCalculator(size: FontSize.button_14))
    ...
    //MARK: - Getters
    fileprivate var allItemLabels: [UIButton] = []
    fileprivate var allSelectedItemLabels: [UIButton] = []
    ...
    fileprivate func labelForPoint(_ point: CGPoint) -> UIButton {
    ...
    fileprivate func selectedLabelForPoint(_ point: CGPoint) -> UIButton {
...
extension HomeSegmentedControl {
    ...
    fileprivate func createLabelWithTitle(_ attributedTitle: NSAttributedString, tag: Int, image:UIImage?) -> UIButton {
        ...
        label.contentEdgeInsets = UIEdgeInsets.init(top: 0, left: 0, bottom: 0, right: 0)
...
extension HomeSegmentedControl {
    ...
    fileprivate func updateFrameForLables(_ allLabels: [UIButton]) {
...
extension HomeSegmentedControl {
    ...
    fileprivate func didEndTouchWithPoint(_ point: CGPoint) {
        ...
        let index = label.tag
        let title = label.title(for: .normal)
...
extension HomeSegmentedControl {
    ...
    fileprivate func updateSelectedViewFrameForLabel(_ label: UIButton) {
    ...
    fileprivate func labelsForPoint(_ point: CGPoint) -> (leftLabel: UIButton, rightLabel: UIButton){
        let label = labelForPoint(point)
...
extension HomeSegmentedControl {
    ...
    open func changeTitle(_ title: String, atIndex: Int) {
        ...
        label.setAttributedTitle(attributedStringForText(title, isSelected: false), for: .normal)
        selecteLabel.setAttributedTitle(attributedStringForText(title, isSelected: true), for: .normal)
        ...
        if attributedDefaultTitles != nil {
            attributedDefaultTitles![atIndex] = label.attributedTitle(for: .normal)!
            attributedSelectedTitles![atIndex] = selecteLabel.attributedTitle(for: .normal)!
        }
    ...
    open func changeAttributedTitle(_ title: NSAttributedString, selectedTile: NSAttributedString?, atIndex: Int) {
        ...
        selecteLabel.setAttributedTitle(selectedTile, for: .normal)
