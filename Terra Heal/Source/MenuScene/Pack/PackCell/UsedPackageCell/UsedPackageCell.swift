...
class UsedPackageCell: SelectionBorderTableCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        self.radius = 15
        self.vwCellBg.backgroundColor = UIColor.init(hex: "#B2B3B5")
    ...
    func setData(data: SubPackageDetail ) {
        ...
        self.btnBook.setTitle("BTN_USE".localized(), for: .normal)
        self.btnBook.fillButton(textColor: UIColor.themeLightTextColor, backgroundColor: UIColor.init(hex: "#6D6E71"), borderColor: .clear, buttonHeight: CommonSize.Button.cellButton)
    }
