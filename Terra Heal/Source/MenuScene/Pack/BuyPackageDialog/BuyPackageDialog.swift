...
class BuyPackageDialog: ThemeBottomDialogView {
    ...
    var arrForData: [CustomButtonDetail] = [CustomButtonDetail(isSelected: true, id: 0, title: "buy it for yourself", type: 0),CustomButtonDetail(isSelected: false, id: 1, title: "gift a pack", type: 1)]
...
extension BuyPackageDialog : UITableViewDelegate,UITableViewDataSource {
