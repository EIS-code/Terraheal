...
class ReviewAndBookVC: MainVC {
    ...
    func initialViewSetup() {
        ...
        self.lblTitleDetail?.setFont(name: FontName.Regular, size: FontSize.label_14)
        ...
        self.lblServiceCenterName?.setFont(name: FontName.Regular, size: FontSize.label_14)
        self.lblServiceCenterAddress?.setFont(name: FontName.SemiBold, size: FontSize.label_18)
        self.lblBookingDate?.setFont(name: FontName.Regular, size: FontSize.label_14)
